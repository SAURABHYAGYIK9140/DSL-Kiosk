...
import 'package:dsl_kiosk/utils/permission_utils.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:mek_stripe_terminal/mek_stripe_terminal.dart';
import 'package:permission_handler/permission_handler.dart';

import '../../models/discovery_method.dart';
import '../../models/k.dart';
import '../../stripe_api.dart';



class Stripeterminal extends StatefulWidget {
  const Stripeterminal({super.key});

  @override
  State<Stripeterminal> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<Stripeterminal> {
